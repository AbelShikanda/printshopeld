(function($) {
    ...
    jQuery(document).ready(function($) {
        ...
        $('.quantity-right-plus').on("click", function(e) {
            e.preventDefault();
            let quantity = parseInt($(this).parent().siblings("input-number").val());
            $(this).parent().siblings("input-number").val(quantity += 1);
        });
    ...
    $('.slider-nav').slick({
        ...
        prevArrow: '<i class="bi bi-chevron-right slick-prev"></i>',
